...
#define CCU6_0_CH0_ISR_PRIORITY 150  //定义CCU6_0 PIT通道0中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
...
#define CCU6_1_CH0_ISR_PRIORITY 110

#define CCU6_1_CH1_INT_SERVICE  IfxSrc_Tos_cpu0
#define CCU6_1_CH1_ISR_PRIORITY 130
