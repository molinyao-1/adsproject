...
void BatterySCM_Get()
{
//    batterylast = 0.8*battery+0.2* batterylast;
//    battery = batterylast;
    ...
    if((battery>batterylimit)&&(batterylast>batterylimit)&&(battery>batterylast))
    {
        gogoflag = 1;
    }
}
...
void Battery_Get()
{
    ...
    battery = (battery/20)/255*3.3*11;//��ƽ��ֵ�����в���
}
void Icharge_Get()
{
    for(int i = 0;i<32;i++)
