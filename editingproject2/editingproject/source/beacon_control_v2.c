...
#define deadgeerleft  480 //6800
#define deadgeerright 510  //5810
extern int gogoflag;
...
{
        /*舵机的占空比中值需要重新测*/
//        SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM1_1_TOUT31_P33_9_OUT,333,6320);
//左
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_0_TOUT53_P21_2_OUT,20000,0);
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_1_TOUT54_P21_3_OUT,20000,0); //给占空比反转
//右
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_3_TOUT56_P21_5_OUT,20000,0); //给正占空比反转
...
void Servo_control()
{
    ...
    if(servoinit == 1&&flagservo ==0)
    {
        ...
        if(servodirection == -1)
        {
            SmartCar_Gtm_Pwm_Setduty(&IfxGtm_ATOM1_1_TOUT31_P33_9_OUT,(uint32_t)(6320-deadgeerright));
        }
        else if(servodirection == 1)
        {
            SmartCar_Gtm_Pwm_Setduty(&IfxGtm_ATOM1_1_TOUT31_P33_9_OUT,(uint32_t)(6320+deadgeerleft));
        }
        ...
        else if(servodirection == 0)
        {
            ...
            if(gogoflag == 1)
            {
                SmartCar_Gtm_Pwm_Setduty(&IfxGtm_ATOM1_1_TOUT31_P33_9_OUT,(uint32_t)(6320-servo_pulse));
            }
...
//            else if(mode_flag == 3)
//            {
//                if(leftFTM>5&&rightFTM>5)
//                {
//                   SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_0_TOUT53_P21_2_OUT,20000,(uint32)0);
//                   SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_1_TOUT54_P21_3_OUT,20000,(uint32)6000); //给占空比反转
//       //右
//                   SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_3_TOUT56_P21_5_OUT,20000,(uint32)6000); //给正占空反转
//                   SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_2_TOUT55_P21_4_OUT,20000,(uint32)0);
//                }
//                else
//                {
//                    SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_0_TOUT53_P21_2_OUT,20000,(uint32)0);
//                    SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_1_TOUT54_P21_3_OUT,20000,(uint32)0); //给占空比反转
//        //右
//                    SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_3_TOUT56_P21_5_OUT,20000,(uint32)0); //给正占空反转
//                    SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_2_TOUT55_P21_4_OUT,20000,(uint32)0);
//                }
//            }
        ...
        if(go_flag&(mode_flag == 0||mode_flag == 1||mode_flag == 2)) //进入跑车状态
        {
//左
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_0_TOUT53_P21_2_OUT,20000,(uint32)Flefdevn);
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_1_TOUT54_P21_3_OUT,20000,(uint32)NFlefdevn); //给占空比反转
//右
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_3_TOUT56_P21_5_OUT,20000,(uint32)NFrigdevn); //给正占空反转
            SmartCar_Gtm_Pwm_Init(&IfxGtm_ATOM0_2_TOUT55_P21_4_OUT,20000,(uint32)Frigdevn);
        }
//        if(go_flag == 0)//要停车了
//        {
